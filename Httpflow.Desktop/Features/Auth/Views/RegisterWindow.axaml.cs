...
namespace Httpflow.Desktop.Features.Auth.Views;
...
public partial class RegisterWindow : Window
{
    ...
    public RegisterWindow(string? initialErrorMessage = null)
    {
        InitializeComponent();
    ...
    private async void OnRegisterButtonClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        await SubmitRegisterAsync();
    }

    private void OnGoToLoginButtonClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
    ...
    {
        await CurrentApp.JwtSessionService.SaveAsync(response.AccessToken, response.ExpiresAtUtc);
