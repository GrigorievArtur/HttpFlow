...
public sealed class ProjectSession
{
    ...
    public async Task<ProjectSessionState?> LoadProjectById(int projectId)
    {
        ...
        _app.SelectedProject = project;
        _app.SelectedProjectId = project.Id;
        _app.SelectedProjectName = project.Name;
    ...
    public async Task<ApiResult<ProjectDto>> SaveCurrentProject()
    {
        ...
        var token = await _app.JwtService.GetTokenAsync();
        ...
        {
            _app.SelectedProject = result.Data;
            _app.SelectedProjectId = result.Data.Id;
            _app.SelectedProjectName = result.Data.Name;
    ...
    public async Task<ApiResult<ProjectDto>> DeleteProjectById(int projectId)
    {
        ...
        if (result.IsSuccess)
        {
            ...
            if (_app.SelectedProjectId == projectId)
            {
                _app.SelectedProject = null;
                _app.SelectedProjectId = null;
                _app.SelectedProjectName = null;
            }
    ...
    {
        if (_app.SelectedProject is not null && _app.SelectedProject.Id == projectId)
        {
            return _app.SelectedProject;
        }
